#[test_only]
module sui_marketplace::arena_tests;

// ========================== DO NOT EDIT THIS FILE ==========================

use sui_marketplace::arena::{Self, Arena, ArenaCreated, ArenaCompleted};
use sui_marketplace::hero::{Self, Hero, HeroMetadata};
use sui_marketplace::marketplace::{Self, ListHero, AdminCap, HeroListed, HeroBought};
use sui::coin;
use sui::sui::SUI;
use sui::transfer;
...
#[test]
#[expected_failure(abort_code = 1)] // EInvalidPayment = 1
